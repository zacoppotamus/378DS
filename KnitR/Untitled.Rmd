...
And although we found that cost also had a slight correlation with hospital quality locally:
...
That correlation dropped off at the national level:
...
We did see that insured cost was highly correlated with insured cost:

![](Screenshots/UninsuredVSInsured.jpg)

And that states with high costs for insured patients tended towards voting Democratic, with younger and sparser populations. 
...
##Medicare and Health Care Access
Being over 62 was also a factor for falling into the group we found was most likely to receive care at 98.4%

![](Screenshots/MostLikely.png)

##Medicare and Health Care Access
However, those uninsured and 65 and over fell into the group of people least likely to receive care, as found by an Oracle clustering model.
...
###Total Cost
Intersection of the highest Medicare and Copay clusters yielded 4 states: 
Wyoming, Alaska, South Dakota, and Idaho

###Joined Data
The data for the 4 states were filtered and isolated to be compared to other datasets to see if there was any common factors among the states. 

The datasets chosen were: Presidential Election and Crime Rates

![](img/Pics/orcl1.png)

###Presidential Election 2012
With the joined data, an explore data was made - grouped by the winning candidate
The outcome:
- SD: Obama
- ID: Obama
- WY: Romney
...
A democratic majority persists the most expensive Medicare and Copay states

![](img/Pics/pres.png)

###Crime Rates
Joining the 4 states' data with Crime Rates, the following graph was produced:

![](img/Pics/crime.png)

The colors indicate crime rates, and the crime rate numbers were produced by the number of crimes tha occured in each state over a course of 50 years.

No correlation was found for Crime Rates and Medicare/Copay costs.
