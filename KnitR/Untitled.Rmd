...
Bu that correlation dropped off at the national level:
...
To find other correlations, we wanted to see if there were any states that stood out with higher costs in both Medicare and copay costs and see if we could find any common factors among these high-cost states.
